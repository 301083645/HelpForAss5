...
namespace HelpForAss5 {
    ...
    public partial class Lesson11DBDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            this.DataSetName = "Lesson11DBDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Lesson11DBDataSet.xsd";
        ...
        public partial class ContactsDataTable : global::System.Data.TypedTableBase<ContactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ContactsRow AddContactsRow(string FirstName, string LastName, string EmailAddress, string ContactNumber) {
        ...
        public partial class ContactsRow : global::System.Data.DataRow {
            ...
            public string ContactNumber {
                get {
                    return ((string)(this[this.tableContacts.ContactNumberColumn]));
                }
                set {
...
namespace HelpForAss5.Lesson11DBDataSetTableAdapters {
    ...
    public partial class ContactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Contacts] WHERE (([Id] = @Original_Id) AND ([FirstName] = @Ori" +
                "ginal_FirstName) AND ([LastName] = @Original_LastName) AND ([EmailAddress] = @Or" +
                "iginal_EmailAddress) AND ([ContactNumber] = @Original_ContactNumber))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Contacts] ([FirstName], [LastName], [EmailAddress], [ContactNu" +
                "mber]) VALUES (@FirstName, @LastName, @EmailAddress, @ContactNumber);\r\nSELECT Id" +
                ", FirstName, LastName, EmailAddress, ContactNumber FROM Contacts WHERE (Id = SCO" +
                "PE_IDENTITY())";
...
SELECT Id, FirstName, LastName, EmailAddress, ContactNumber FROM Contacts WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HelpForAss5.Properties.Settings.Default.Lesson11DBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, EmailAddress, ContactNumber FROM dbo.Contacts";
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_EmailAddress, string Original_ContactNumber) {
        ...
        public virtual int Insert(string FirstName, string LastName, string EmailAddress, string ContactNumber) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string EmailAddress, string ContactNumber, int Original_Id, string Original_FirstName, string Original_LastName, string Original_EmailAddress, string Original_ContactNumber, int Id) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string EmailAddress, string ContactNumber, int Original_Id, string Original_FirstName, string Original_LastName, string Original_EmailAddress, string Original_ContactNumber) {
            return this.Update(FirstName, LastName, EmailAddress, ContactNumber, Original_Id, Original_FirstName, Original_LastName, Original_EmailAddress, Original_ContactNumber, Original_Id);
        }
    }
